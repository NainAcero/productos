<?php /* Smarty version Smarty-3.1.13, created on 2020-10-12 22:08:26
...
<?php }?></option>
                                    ...
                                    <div class="form-group">
                                        <label for="invoicenum"
                                               class="control-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoice Prefix'];?>
</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-horizontal">
                                    <?php if ($_smarty_tpl->tpl_vars['recurring']->value){?>
                                        <div class="form-group">
                                            <label for="inputEmail3"
                                                   class="control-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Repeat Every'];?>
</label>
                                    ...
                                    <div class="form-group">
                                        <label for="inputEmail3"
                                               class="control-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoice Date'];?>
</label>
...
">
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword3"
                                               class="control-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Payment Terms'];?>
</label>
