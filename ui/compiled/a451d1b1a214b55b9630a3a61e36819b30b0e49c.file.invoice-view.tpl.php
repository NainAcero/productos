<?php /* Smarty version Smarty-3.1.13, created on 2020-10-14 12:55:47
                    ...
                    <header class="clearfix">
                        <div class="row">
                            <div class="col-sm-6 mt-md">
                                <span class="h2 mt-none mb-sm text-dark text-bold"><?php echo $_smarty_tpl->tpl_vars['_L']->value['INVOICE'];?>
 #<?php echo $_smarty_tpl->tpl_vars['d']->value['invoicenum'];?>
<?php if ($_smarty_tpl->tpl_vars['d']->value['cn']!=''){?> <?php echo $_smarty_tpl->tpl_vars['d']->value['cn'];?>
 <?php }else{ ?> <?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
 <?php }?></span>
                                <?php if ($_smarty_tpl->tpl_vars['d']->value['status']=='Unpaid'){?>
                                    <span class="font-bold m-l-md alert alert-danger"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Unpaid'];?>
</span>
                                <?php }elseif($_smarty_tpl->tpl_vars['d']->value['status']=='Paid'){?>
                                    <span class="font-bold m-l-md alert alert-success"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Paid'];?>
</span>
                                <?php }elseif($_smarty_tpl->tpl_vars['d']->value['status']=='Partially Paid'){?>
                                    <span class="font-bold m-l-md alert alert-info"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Partially Paid'];?>
</span>
                                <?php }else{ ?>
                                    <span class="font-bold m-l-md alert alert-info"><?php echo $_smarty_tpl->tpl_vars['d']->value['status'];?>
</span>
                                <?php }?>
                            </div>
...
sysfrm/uploads/system/logo-black.svg" alt="Logo">
                                </div>
                            </div>
                        </div>
                    </header>
...
:</span>
                                    ...
                                    <h2 class="font-bold"> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoice Total'];?>
