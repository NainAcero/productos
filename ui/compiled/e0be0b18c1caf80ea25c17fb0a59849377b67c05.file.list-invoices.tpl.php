<?php /* Smarty version Smarty-3.1.13, created on 2020-10-14 11:34:32
...
invoices/list/filter/" class="btn btn-primary btn-xs"><i class="fa fa-search"></i> Buscar</a>
                <?php }else{ ?>
                <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
invoices/list/" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left"></i> Atras</a>
            <?php }?>
...
"><i class="fa fa-trash"></i></a>
        ...
        <div class="d-flex">
            ...
            <?php if ($_smarty_tpl->tpl_vars['view_type']->value!='filter'){?>
            <span><?php if ($_smarty_tpl->tpl_vars['paginator']->value['found']>0){?><?php echo $_smarty_tpl->tpl_vars['_L']->value['Page'];?>
