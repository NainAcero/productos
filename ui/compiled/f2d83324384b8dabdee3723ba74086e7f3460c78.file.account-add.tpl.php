<?php /* Smarty version Smarty-3.1.13, created on 2020-10-12 22:03:12
    ...
    <div class="col-md-6">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form role="form" class="form-horizontal" name="accadd" method="post" action="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
accounts/add-post">
                    <div class="form-group">
                        <label class="control-label" for="account"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Account Title'];?>
*</label>
                    ...
                    <div class="form-group">
                        <label class="control-label" for="balance"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Initial Balance'];?>
</label>
