                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="bill-data text-right">
                                ...
                                <h2> {$_L['Invoice Total']}: {ib_money_format($d['total'],$_c)} </h2>
                                {if ($d['credit']) neq '0.00'}
                                    <h2> {$_L['Total Paid']}: {ib_money_format($d['credit'],$_c)}</h2>
                                    <h2> {$_L['Amount Due']}: {ib_money_format($i_due,$_c)}</h2>
                                {/if}
                    ...
                    <table class="table invoice-items">
                        ...
                        {foreach $items as $item}
                            <tr>
                                ...
                                <td class="text-center">{ib_money_format($item['amount'],$_c)}</td>
                                <td class="text-center">{$item['qty']}</td>
                                <td class="text-center">{ib_money_format($item['total'],$_c)}</td>
                            </tr>
                        {/foreach}
                        ...
                        <div class="col-sm-4 col-sm-offset-8">
                            <table class="table h5 text-dark">
                                ...
                                <tr class="b-top-none">
                                    ...
                                    <td class="text-left">{ib_money_format($d['subtotal'],$_c)}</td>
                                </tr>
                                ...
                                {if ($d['discount']) neq '0.00'}
                                    <tr>
                                        ...
                                        <td class="text-left">{ib_money_format($d['discount'],$_c)}</td>
                                    </tr>
                                {/if}

                                <tr>
                                    <td colspan="2">{$_L['TAX']}</td>
                                    <td class="text-left">{ib_money_format($d['tax'],$_c)}</td>
                                </tr>
                                {if ($d['credit']) neq '0.00'}
                                    <tr>
                                        <td colspan="2">{$_L['Total']}</td>
                                        <td class="text-left">{ib_money_format($d['total'],$_c)}</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">{$_L['Total Paid']}</td>
                                        <td class="text-left">{ib_money_format($d['credit'],$_c)}</td>
                                    </tr>
                                    <tr class="h4">
                                        <td colspan="2">{$_L['Amount Due']}</td>
                                        <td class="text-left">{ib_money_format($i_due,$_c)}</td>
                                    </tr>
                                {else}
                                    <tr class="h4">
                ...
                <table class="table table-bordered sys_table">
                    ...
                    {foreach $trs as $tr}
                        <tr class="{if $tr['cr'] eq '0.00'}warning {else}info{/if}">
                            ...
                            <td class="text-right">{ib_money_format($tr['amount'],$_c)}</td>
